describe("My callout", function () {
    ...
    it("Should hit remote endpoint", function () {
        ...
        BackEndServiceCaller.doserverCallout(function() {
    ...
    it ("Should hit a server for data", function() {
        server.respondWith("GET", "/licenseholder/index", [
            200, {"Content-Type":"application/json"}, JSON.stringify(data)
        ]);

        var callback = jasmine.createSpy('callback')
        BackEndServiceCaller.doserverCallout(callback)
        server.respond();
